---
title: "Candidate Gene Analysis, Regression method, viral genes"
...
load("candidateGeneAnalysis_regression-viral.Rws")
```
...
Note: The control samples are plotted, but they are not factored into the displayed regression line
```{r, message = FALSE, warning = FALSE, echo = FALSE}
correlationPlot <- function(target, targetTissue, targetLevel, ...) {
  ...
  plot <- lcpm.all %>%
    ...
    geom_smooth(data = nonCtl, method = "lm", color = "black") +
